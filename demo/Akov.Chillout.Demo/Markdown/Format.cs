...
public class Format
{
    ...
    public static string? Bold(string? text) => text is null ? null : $"**{text}**";
    public static string? Italic(string? text) => text is null ? null : $"*{text}*";
    public static string? Underline(string? text) => text is null ? null : $"<u>{text}</u>";
    public static string? CrossedOut(string? text) => text is null ? null : $"~~{text}~~";
